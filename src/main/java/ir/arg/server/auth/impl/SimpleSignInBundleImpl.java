...
public class SimpleSignInBundleImpl implements SignInBundle {

    @NotNull
    private final String enteredUsername, enteredPassword, generatedToken;

    public SimpleSignInBundleImpl(@NotNull String enteredUsername, @NotNull String enteredPassword, @NotNull String generatedToken) {
